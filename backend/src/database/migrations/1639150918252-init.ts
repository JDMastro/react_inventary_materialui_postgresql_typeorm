...
export class init1639150918252 implements MigrationInterface {
    name = 'init1639150918252'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movements" ("id" SERIAL NOT NULL, "product_id" integer NOT NULL, "quantity" double precision NOT NULL, "totalPurchasePrice" double precision NOT NULL, "unitPrice" double precision NOT NULL, "header_id" integer NOT NULL, "quantity_returned" double precision NOT NULL, "status_id" integer, CONSTRAINT "PK_5a8e3da15ab8f2ce353e7f58f67" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "header" ("id" SERIAL NOT NULL, "person_id" integer NOT NULL, "number_order" integer NOT NULL, "creation_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(3) NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "delete_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "kind_movements" integer NOT NULL, CONSTRAINT "PK_007a885cf40484eb750d0355339" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "settings" ("id" SERIAL NOT NULL, "key" character varying NOT NULL, "value" character varying NOT NULL, CONSTRAINT "idx_settings" UNIQUE ("key"), CONSTRAINT "PK_0669fe20e252eb692bf4d344975" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "header" ADD CONSTRAINT "FK_c959c601d7efbd0b0626e833c2c" FOREIGN KEY ("kind_movements") REFERENCES "kind_movements"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "header" DROP CONSTRAINT "FK_c959c601d7efbd0b0626e833c2c"`);
