    ...
    return (
        <Box sx={{ p: 2 }}>
            ...
            <AlertDialogUi
                ...
                content={<UpdateMovements handleClose={handleCloseModalUpdate} setRefresh={setRefresh} refresh={refresh} data={data} />}
            ...
            <AlertDialogUi
                ...
                content={<Addkindmovements refresh={refresh} setRefresh={setRefresh} handleClose={handleCloseModalAdd} />}
                open={openModalAdd}
                title="Add"
            />
        </Box>
